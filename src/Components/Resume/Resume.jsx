        ...
        <div className="resume__parent">
          ...
          <div className="resume__children">
            ...
            <div className="resume__item">
              ...
              <div className="resume__item__body">
                ...
                <div className="resume__body">
                  ...
                  <h5>
                    Church of Christ Junior High Education, Ejura - Ashanti
                  </h5>
                  <p>
                    Qui deserunt veniam. Et sed aliquam labore tempore sed
                    quisquam iusto autem sit. Ea vero voluptatum qui ut
                    dignissimos deleniti nerada porti sand markend Innovative
                    and deadline-driven Web Designer with 3+ years of experience
                    designing and developing user-centered digital/print
            ...
            <div className="resume__item">
              <h2 className="resume__item__title"></h2>
              <div className="resume__item__body">
                <h2 className="reduce__me__400">
                  <strong>B.Sc (HIM)</strong>
                </h2>
                <div className="resume__body">
          ...
          <div className="resume__space__bottom"></div>
        </div>
      </div>
    </section>
  );
